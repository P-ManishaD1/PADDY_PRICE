 ...
 <body>
           ...
           <div class="row" style="text-align:center;">
                <div class="col-md-4 col-sm-12">
                     <a href="bhome.php" id="navbar"><i class="fa fa-home" aria-hidden="true"></i><label>హోమ్</label></a>
                </div>
                <div class="col-md-4 col-sm-12">
                     <a href="MyProducts.php" id="navbar"><i class="fa fa-rupee" aria-hidden="true"></i><label>ధరల నవీకరణ</label></a>
                </div>
