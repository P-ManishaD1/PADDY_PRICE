                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header border border-dark" style="background-color:#292b2c">
                            <h4 style="font-style:bold;color:goldenrod;text-align:left">లాగిన్</h4>
                        </div>
                        <div class="card-body border border-dark">
                            <form name="my-form" action="BuyerLogin.php" method="post">

                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right  "><b><i class="fas fa-phone-alt mr-2"></i>ఫోన్ నెంబర్</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="p1" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-lock mr-2"></i>పాస్వర్డ్ </b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <br>
                                    <label id="account"><a id='link' href="BuyerRegistration.php"><b style="color:black">కొత్త ఖాతాను ఓపెన్ చేసుకోండి</b></a></label>
                                </div>
                            </form>
                        </div>
                    </div>
