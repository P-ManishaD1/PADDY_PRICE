				...
				<div class="col-md-8">
					<div class="card " >
						<div class="card-header text-left" style="background-color:#292b2c">
							<h4  style="font-style:bold;color:goldenrod;text-align:left">లాగిన్ అవ్వండి </h4>
						</div>
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									...
									<br>
									<label id="account" class="text-left"><a id='link' href="FarmerRegister.php"><b style="color:black">కొంత ఎకౌంటు ఓపెన్ చేసుకోండి</b></a></label>
								</div>
							</form>
						</div>
					</div>
