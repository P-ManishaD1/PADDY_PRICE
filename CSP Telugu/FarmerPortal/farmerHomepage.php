      ...
      <body>
           ...
           <div class="row" style="text-align:center;">
                <div class="col-md-4 col-sm-12">
                     <a href="farmerHomepage.php" id="navbar"><i class="fa fa-home" aria-hidden="true"></i><label>హోమ్</label></a>
                </div>
                <div class="col-md-4 col-sm-12">
                     <a href="MyProducts.php" id="navbar"><i class="fa fa-rupee" aria-hidden="true"></i><label>ధరలు</label></a>
                </div>
                <!--<div class="col-md-3 col-sm-12">
                     <a href="Transactions.php" id="navbar"><i class="fa fa-exchange" aria-hidden="true"></i><label>My Transactions</label></a>
                </div>-->
                <div class="col-md-4 col-sm-12">
                     <a href="CallCenter.php" id="navbar"><i class="fa fa-users" aria-hidden="true"></i><label>గురించి</label></a>
                </div>
           </div>
           <hr>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          ...
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="second.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="third.jpg" alt="Second slide">
                          </div>
