        ...
        <tr>
            <td>
                <table align="center">
                    ...
                    <tr>
                        <td>Price for 1kg : RS <?=$b1?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 20kgs : RS <?=$b20?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1 Quintal : RS <?=$b100?>/-</td>
                    </tr>
                </table>
            </td>
            <td>
                <table align="center">
                    ...
                    <tr>
                        <td>Price for 1kg : RS <?=$s1?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 20kgs : RS <?=$s20?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1 Quintal : RS <?=$s100?>/-</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td>
                <table align="center">
                    ...
                    <tr>
                        <td>Price for 1kg : RS <?=$sa1?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 20kgs : RS <?=$sa20?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1 Quintal : RS <?=$sa100?>/-</td>
                    </tr>
                </table>
            </td>
            <td>
                <table align="center">
                    ...
                    <tr>
                        <td>Price for 20kgs : RS <?=$m1?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1kg : RS <?=$m20?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1 Quintal : RS <?=$m100?>/-</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td>
                <table align="center">
                    ...
                    <tr>
                        <td>Price for 1kg : RS <?=$k1?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 20kgs : RS <?=$k20?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1 Quintal : RS <?=$k100?>/-</td>
                    </tr>
                </table>
            </td>
            <td>
                <table align="center">
                    ...
                    <tr>
                        <td>Price for 20kgs : RS <?=$i1?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1kg : RS <?=$i20?>/-</td>
                    </tr>
                    <tr>
                        <td>Price for 1 Quintal : RS <?=$i100?>/-</td>
                    </tr>
                </table>
            </td>
        </tr>
