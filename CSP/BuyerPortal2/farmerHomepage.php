 ...
 <head>
      ...
      <body>
           ...
           <div class="row" style="text-align:center;">
                ...
                <div class="col-md-4 col-sm-12">
                     <a href="MyProducts.php" id="navbar"><i class="fa fa-rupee" aria-hidden="true"></i><label>Prices</label></a>
                </div>
               <!--<div class="col-md-3 col-sm-12">
                     <a href="Transactions.php" id="navbar"><i class="fa fa-exchange" aria-hidden="true"></i><label>My Transactions</label></a>
                </div>-->
                <div class="col-md-4 col-sm-12">
                     <a href="CallCenter.php" id="navbar"><i class="fa fa-phone fa-rotate-vertical" aria-hidden="true"></i><label>About Us</label></a>
                </div>
           </div>
           <hr>
