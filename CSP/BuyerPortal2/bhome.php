<?php
 ...
 <head>
      ...
      <script src="../portal_files/jquery.min.js"></script>
      <script src="../portal_files/popper.min.js"></script>
      <script src="../portal_files/bootstrap.min.js"></script>
 ...
 <body>
           ...
           <div class="row" style="text-align:center;">
                <div class="col-md-4 col-sm-12">
                     <a href="bhome.php" id="navbar"><i class="fa fa-home" aria-hidden="true"></i><label>Home</label></a>
                </div>
                <div class="col-md-4 col-sm-12">
                     <a href="MyProducts.php" id="navbar"><i class="fa fa-rupee" aria-hidden="true"></i><label>Prices Updates</label></a>
                </div>
               <!--<div class="col-md-3 col-sm-12">
                     <a href="Transactions.php" id="navbar"><i class="fa fa-exchange" aria-hidden="true"></i><label>My Transactions</label></a>
                </div>-->
                <div class="col-md-4 col-sm-12">
                     <a href="CallCenter.php" id="navbar"><i class="fa fa-users" aria-hidden="true"></i><label>About Us</label></a>
                </div>
           </div>
           <hr>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="first.png" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="home1.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="home2.jpg" alt="Second slide">
                          </div>
