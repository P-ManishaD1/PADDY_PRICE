...
@media (max-width: 768px) {
   ...
   <iframe src='top.htm' width=100% height=150></iframe>
    <table align="center" width="80%" border='2'>
        ...
        <tr>
            <td colspan=2 align="center" style='color:white;background-color:green;'><input type='submit' value='UPDATE PRICES'></td>
           </tr>
    </table>
